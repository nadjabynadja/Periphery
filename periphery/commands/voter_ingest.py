...
Usage:
    python -m periphery.commands.voter_ingest --state NC --download --db ./data/analytical.db
    python -m periphery.commands.voter_ingest --state NC --download --limit 1000 --db ./data/analytical.db
